...
Matrix3D.prototype = {
  ...
  multiplyMatrices(a, be) {
    ...
    const b11 = be[0]; const b12 = be[1]; const b13 = be[2]; const
      b14 = be[3];
    const b21 = be[4]; const b22 = be[5]; const b23 = be[6]; const
      b24 = be[7];
    const b31 = be[8]; const b32 = be[9]; const b33 = be[10]; const
      b34 = be[11];
    const b41 = be[12]; const b42 = be[13]; const b43 = be[14]; const
      b44 = be[15];
...
const Transform = function (element) {
  observe(
    element,
