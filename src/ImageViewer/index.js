...
import Finger from './libs/finger.js';
import Transform from './libs/transform.js';
import { CenterImage } from './libs/components.js';
import Singleton from './libs/singleton.js';
...
class ImageView extends Component {
    ...
    componentDidMount() {
      ...
      const { imagelist, initCallback } = this.props;
    ...
    onPinch(evt) {
      ...
      const originX2 = evt.center.x - this.screenWidth / 2 - document.body.scrollLeft;
      const originY2 = evt.center.y - this.screenHeight / 2 - document.body.scrollTop;
